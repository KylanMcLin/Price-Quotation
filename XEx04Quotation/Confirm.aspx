        ...
        <main class="container">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <%-- buttons go here --%>
                    <asp:Button ID="sendQuotButton" runat="server" Text="Send Quotation" CssClass="btn btn-primary" OnClick="sendQuotButton_Click" />
                    <asp:Button ID="returnButton" runat="server" Text="Return" CssClass="btn btn-primary" PostBackUrl="~/Default.aspx" />
                </div>
            </div> 
            ...
            <div class="form-group">
                <div class="col-sm-offset-1 col-sm-11">
                    ...
                    <asp:Label ID="lblMessage" runat="server" Text="Click the Send Quotation button to send the quotation via email"></asp:Label>
                </div>
            </div>
